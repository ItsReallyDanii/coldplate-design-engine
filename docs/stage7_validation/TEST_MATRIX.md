...
| Steady-state criterion | < 0.5 °C/min drift for 5 consecutive min | — |
...
| Flow rate (Q) | At ΔP ≈ 1000 Pa | 3 rates: 0.5×, 1×, 1.5× nominal |
...
|----------|----------|--------|-------|
| R_th | 11.27 K/W | Stage 5 | SIMULATED |
| ΔP | 1000 Pa | Stage 4 | SIMULATED |
| Q at ΔP = 1000 Pa | 44.02 LPM | Stage 4 | FLOW_SIMULATED |
| T_peak at 25 W | 70.06 °C | Stage 5 | SIMULATED |

### 5.2 Acceptance Bands

| Quantity | Lower bound | Upper bound | Ratio basis |
|----------|------------|------------|-------------|
| R_th (K/W) | 5.63 | 22.53 | 0.5× to 2.0× predicted |
| ΔP (Pa) | 333 | 3000 | 0.33× to 3.0× predicted |
| Q (LPM) | 22 | 88 | 0.5× to 2.0× predicted |
